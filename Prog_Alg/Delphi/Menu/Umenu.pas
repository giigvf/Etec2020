...
begin
      try
          frmClientes:= frmClientes.Create(Application);    // Cria frm na memória
          frmClientes.ShowModal;                             // Chama o frm
      finally
          FreeAndNil(frmClientes);                           // deleta o frm da memória
      end;
end;
...
begin
      try
          frmProdutos:= frmProdutos.Create(Application);     // Cria frm na memória
          frmProdutos.ShowModal;                             // Chama o frm
      finally
          FreeAndNil(frmProdutos);                           // deleta o frm da memória
      end;
end;
